...
PERSONA_CONFIGS: Dict[Persona, PersonaConfig] = {
    Persona.SALARY_CORE: PersonaConfig(
        ...
        profile_json='adults_2550_male_urban.json',
        # $45k-$120k
        income_log_mu=11.22,
        income_log_sigma=0.35,
        income_clip_min=45000.0,
        income_clip_max=120000.0,
    ...
    Persona.AFFLUENT_MULTI_PRODUCT: PersonaConfig(
        ...
        profile_json='adults_2550_female_urban.json',
        # $150k-$600k
        income_log_mu=12.42,
        income_log_sigma=0.40,
        income_clip_min=150000.0,
        income_clip_max=600000.0,
    ...
    Persona.DIGITAL_NATIVE: PersonaConfig(
        ...
        profile_json='young_adults_female_urban.json',
        # $50k-$150k
        income_log_mu=11.28,
        income_log_sigma=0.40,
        income_clip_min=50000.0,
        income_clip_max=150000.0,
    ...
    Persona.CREDIT_STRESSED: PersonaConfig(
        ...
        profile_json='fraud_adults_2550_male_urban.json',
        # $35k-$90k
        income_log_mu=10.91,
        income_log_sigma=0.35,
        income_clip_min=35000.0,
        income_clip_max=90000.0,
    ...
    Persona.DORMANT_WEALTHY: PersonaConfig(
        ...
        profile_json='adults_50up_male_rural.json',
        # $200k-$1M
        income_log_mu=12.89,
        income_log_sigma=0.45,
        income_clip_min=200000.0,
    ...
    Persona.COMPLAINT_PRONE_CHURNER: PersonaConfig(
        ...
        profile_json='fraud_adults_50up_female_urban.json',
        # $45k-$140k
        income_log_mu=11.15,
        income_log_sigma=0.40,
        income_clip_min=45000.0,
        income_clip_max=140000.0,
        # medium digital engagement
        digital_engagement_beta_a=5.0,
        digital_engagement_beta_b=5.0,
